...
describe('EdgePathService', () => {
  describe('static methods', () => {
    ...
    describe('#getPortOffsetForNode', () => {
      ...
      it.each([
        { id: 'top1', expected: { x: 66, y: -10 } },
        { id: 'top2', expected: { x: 132, y: -10 } },
        { id: 'right1', expected: { x: 210, y: 25 } },
        { id: 'right2', expected: { x: 210, y: 50 } },
        { id: 'right3', expected: { x: 210, y: 75 } },
        { id: 'left1', expected: { x: -10, y: 25 } },
        { id: 'left2', expected: { x: -10, y: 50 } },
        { id: 'left3', expected: { x: -10, y: 75 } },
        { id: 'bottom1', expected: { x: 100, y: 110 } },
        { id: undefined, expected: { x: 0, y: 0 } },
        { id: 'notfound', expected: { x: 0, y: 0 } },
      ])('when portId is $id', ({ id, expected }) => {
        expect(EdgePathService.getPortOffsetForNode(id, node, padding)).toEqual(
          expected
        );
      });
