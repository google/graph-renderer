...
const INITIAL_GRAPH: Graph = {
  nodes: [
    { id: 'root-node', x: 0, y: 0, width: 120, height: 60, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'root-out', side: Side.BOTTOM}] },
    { id: 'parent-L', x: 0, y: 0, width: 120, height: 60, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'parent-L-in', side: Side.TOP}, {id: 'parent-L-out', side: Side.BOTTOM}] },
    { id: 'parent-M', x: 0, y: 0, width: 120, height: 60, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'parent-M-in', side: Side.TOP}, {id: 'parent-M-out', side: Side.BOTTOM}] },
    { id: 'parent-R', x: 0, y: 0, width: 120, height: 60, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'parent-R-in', side: Side.TOP}, {id: 'parent-R-out', side: Side.BOTTOM}] },
    { id: 'child-LL', x: 0, y: 0, width: 100, height: 50, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'c1', side: Side.TOP}] },
    { id: 'child-LR', x: 0, y: 0, width: 100, height: 50, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'c2', side: Side.TOP}] },
    { id: 'child-ML', x: 0, y: 0, width: 100, height: 50, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'c3', side: Side.TOP}] },
    { id: 'child-RL', x: 0, y: 0, width: 100, height: 50, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'c4', side: Side.TOP}] },
    { id: 'child-RR', x: 0, y: 0, width: 100, height: 50, templateId: NODE_TEMPLATE_ID, dragDisabled: true, ports: [{id: 'c5', side: Side.TOP}] },
  ],
  edges: [
    { id: 'e1', from: {nodeId: 'root-node', portId: 'root-out'}, to: {nodeId: 'parent-L', portId: 'parent-L-in'}, label: {width: 40, height: 20} },
    { id: 'e-mid', from: {nodeId: 'root-node', portId: 'root-out'}, to: {nodeId: 'parent-M', portId: 'parent-M-in'}, label: {width: 40, height: 20} },
    { id: 'e2', from: {nodeId: 'root-node', portId: 'root-out'}, to: {nodeId: 'parent-R', portId: 'parent-R-in'}, label: {width: 40, height: 20} },
    { id: 'e3', from: {nodeId: 'parent-L', portId: 'parent-L-out'}, to: {nodeId: 'child-LL', portId: 'c1'} },
    { id: 'e4', from: {nodeId: 'parent-L', portId: 'parent-L-out'}, to: {nodeId: 'child-LR', portId: 'c2'} },
    { id: 'e5', from: {nodeId: 'parent-M', portId: 'parent-M-out'}, to: {nodeId: 'child-ML', portId: 'c3'} },
    { id: 'e6', from: {nodeId: 'parent-R', portId: 'parent-R-out'}, to: {nodeId: 'child-RL', portId: 'c4'} },
    { id: 'e7', from: {nodeId: 'parent-R', portId: 'parent-R-out'}, to: {nodeId: 'child-RR', portId: 'c5'} },
  ],
};

function mapSideToElk(side: Side): string {
  switch (side) {
    case Side.TOP: return 'NORTH';
    case Side.BOTTOM: return 'SOUTH';
    case Side.LEFT: return 'WEST';
    case Side.RIGHT: return 'EAST';
    default: throw new Error(`Unsupported side value: ${side}`);
  }
}
  ...
  private async runLayout(nodes: BaseNode[], edges: BaseEdge[]) {
    ...
    const elkGraph: ElkNode = {
      ...
      edges: edges.map((e: BaseEdge) => ({
        ...
        labels: e.label ? [{width: e.label.width, height: e.label.height}] : [],
      })),
    };
