...
const INTERACTIVE_NODE_TEMPLATE_DRAG_DISABLED_ID = 'interactive-node-drag-disabled-id';
...
.controls {
    ...
    .controls .minimap, .controls select {
      font-size: 14px;
      padding: 0 8px;
    }
    .control-group {
  ...
  @state() private mouseWheelBehavior: MouseWheelBehavior = MouseWheelBehavior.ZOOM;
  ...
  private get nodeTemplates() {
    return {
      ...
      `,
      [SCROLLABLE_NODE_TEMPLATE_ID]: (nodeId: string) => html`
        <style>
        ...
        <div class="scrollable-node-template">
          ...
          <p>In <b>PAN</b> or <b>ZOOM</b> mode, this content will scroll normally.</p>
          <p>In <b>ZOOM_CAPTURES</b> mode, the graph will zoom instead of this content scrolling.</p>
    ...
    return html`
      ...
      <div class="controls">
        ...
        <div class="control-group">
          ...
          <select id="mouse-wheel-behavior" @change=${this.handleMouseWheelBehaviorChange} title="Mouse Wheel Behavior">
            <option value=${MouseWheelBehavior.PAN} ?selected=${this.mouseWheelBehavior === MouseWheelBehavior.PAN}>PAN</option>
            <option value=${MouseWheelBehavior.ZOOM} ?selected=${this.mouseWheelBehavior === MouseWheelBehavior.ZOOM}>ZOOM</option>
            <option value=${MouseWheelBehavior.ZOOM_CAPTURES} ?selected=${this.mouseWheelBehavior === MouseWheelBehavior.ZOOM_CAPTURES}>ZOOM_CAPTURES</option>
          </select>
        </div>
      </div>
    `;
